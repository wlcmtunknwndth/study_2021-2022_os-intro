...
- Delete-удалить.
- Select group-выбрать несколько файлов
4. User menu-меню пользователя с разнообразными функциями(архивация, к примеру)
- Directory tree-рассматривает файловую систему, как дерево, начиная с корневого каталога
